...
export default function CourseCard({ course, basePath = "/courses" }: Props) {
  ...
  return (
    <Card className="group overflow-hidden rounded-3xl border-white/10 bg-slate-900/70 backdrop-blur transition-all duration-300 hover:-translate-y-2 hover:border-blue-500/40 hover:shadow-xl hover:shadow-blue-900/20">
